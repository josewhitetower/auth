      ...
      <form onSubmit={this.handleChangePassword} className="white">
        <div className="changePassword">
          <div className="input-field">
            <label htmlFor="currentPassword" className="active">
              Current Password
            </label>
            <input
              type="password"
      ...
      <div className="forms">
        <form onSubmit={this.handleSubmit} className="white">
          ...
          <div className="input-field">
            ...
            <div className="center red-text">{this.props.error}</div>
          </div>
